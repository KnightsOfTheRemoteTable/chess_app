...
ActiveRecord::Schema.define(version: 20151205153203) do
  ...
  add_index "chess_pieces", ["game_id"], name: "index_chess_pieces_on_game_id", using: :btree
